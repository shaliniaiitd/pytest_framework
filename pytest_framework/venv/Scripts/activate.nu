...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\Shalini_Agarwal\PycharmProjects\pythonProject2\pytest_framework\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\Shalini_Agarwal\PycharmProjects\pythonProject2\pytest_framework\venv\Scripts\deactivate.nu'
